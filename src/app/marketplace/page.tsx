...
export default function MarketplacePage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-teal-800 mb-1">Marketplace</h1>
      ...
      <div className="flex flex-wrap gap-3 mb-8">
        <select className="bg-white border border-teal-200 text-teal-600 text-sm rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-200">
