  ...
  return (
    <div className="max-w-sm mx-auto px-4 py-16">
      ...
      <div className="bg-white rounded-xl border border-sage-100 p-6 space-y-4">
        <div>
          <label className="block text-sm font-medium text-sage-600 mb-1">Name</label>
          <input
            type="text"
            value={form.name}
        ...
        <div>
          <label className="block text-sm font-medium text-sage-600 mb-1">Email</label>
          <input
            type="email"
            value={form.email}
        ...
        <div>
          <label className="block text-sm font-medium text-sage-600 mb-1">Password</label>
          <input
            type="password"
            value={form.password}
        ...
        <div>
          <label className="block text-sm font-medium text-sage-600 mb-1">Location</label>
          <input
            type="text"
            value={form.location}
