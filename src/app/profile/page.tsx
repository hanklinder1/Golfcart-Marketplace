...
export default function ProfilePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-2xl font-bold text-teal-800 mb-8">Your Profile</h1>

      <div className="bg-white rounded-xl border border-teal-100 p-6 mb-6">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center">
            <User className="text-teal-400" size={28} />
          </div>
          <div>
            <p className="text-teal-400 text-sm">Sign in to view your profile</p>
      ...
      <div className="bg-white rounded-xl border border-teal-100 p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-teal-700">Your Listings</h2>
          <Link
            href="/sell"
