  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        <h1 className="text-2xl font-bold text-sage-800 mb-3">Sell Your Cart</h1>
        <p className="text-sage-400 text-sm mb-6 max-w-md mx-auto">
        ...
        <Link
          href="/sell"
          className="inline-block bg-sage-700 text-white font-medium px-6 py-2.5 rounded-lg hover:bg-sage-800 transition-colors"
        >
          Go to Sell Page
        </Link>
      </div>
